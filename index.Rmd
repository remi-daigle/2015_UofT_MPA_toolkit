...
- The toolbox is a great way to evaluate MPA design strategies
- Some of the modules have room for improvent:
  - Fishermen behaviour
  - Dispersal
  
**Future:**

Implement the toolbox on the BC-cumumber project since we have pre-defined connectivity matrices.